      ...
      <div className=" max-w-[90rem] flex items-center justify-between mx-auto py-[1rem] px-[6rem] max-[480px]:px-[1rem] max-[840px]:px-[3rem] ">
        ...
        <Dialog.Root>
          {isLoggedIn ? (
            ...
            <button
              onClick={login}
              className=" bg-[#009DD80D] px-[1.5rem] py-[0.2rem] flex items-center gap-x-[0.5rem] rounded-[624rem] border border-[#0097CA7D] hover:cursor-pointer  "
            >
              <div>
                <img
                  src={plugwalleticon}
          ...
          <Dialog.Portal>
            ...
            <Dialog.Content className="DialogContent">
              <div className=" flex flex-col items-center gap-y-[0.5rem] ">
                ...
                <button
                  className=" flex justify-center items-center gap-x-[0.5rem] px-[1rem]  rounded-full border border-[#DF000356] h-[2.5rem] min-w-[18.5rem] "
                  onClick={login}
                >
